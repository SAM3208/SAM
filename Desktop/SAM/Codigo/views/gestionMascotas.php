            ...
            <div class="flex justify-center px-6 py-12">
                ...
                <div class="w-full xl:w-3/4 lg:w-11/12 flex shadow-black shadow-2xl">
                    ...
                    <div class="w-full h-auto bg-blue-200 dark:bg-gray-800 hidden lg:block lg:w-5/12 bg-cover rounded-l-lg"
                        style="background-image: url('../img-prin/imgPerroGato.jpg'); background-position: center;"></div>
                    <!-- Col -->
                    <div class="w-full lg:w-7/12 bg-white dark:bg-gray-700 p-5 rounded-lg lg:rounded-l-none">
                        <h3 class="py-4 text-2xl text-center text-gray-800 dark:text-white">REGISTRO DE MASCOTAS</h3>
